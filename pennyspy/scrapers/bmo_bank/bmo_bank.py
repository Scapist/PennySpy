...
bmo = BMOBank()
uuid = "60fdcb8b-061c-5e23-b9e7-c6bd68754de9"
bmo.start_auth(account_uuid=uuid)
otp = ""
bmo.continue_auth(otp_code=otp)
bmo.download_transactions(export_directory=Path(__file__).parent)
